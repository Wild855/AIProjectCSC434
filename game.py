...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, image, platforms, pos, *groups):
        ...
        Parameters
        ---------------
        image		block face avatar
        platforms 	obstacles such as coins, blocks, spikes, and orbs
        pos			starting position
        groups		takes any number of sprite groups
        """
...
levels = ["level_1_copy.csv", "level_2.csv"]    # Trying out changing the level map
